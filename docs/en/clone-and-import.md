...
`git clone https://github.com/ByteLegendQuest/java-create-object-modify-field`

A project directory named `java-create-object-modify-field` will be created, which can be moved wherever you like.

Open `IDEA`, `File` - `Open`, select and open the `pom.xml` in `java-create-object-modify-field` directory which is created just now.
